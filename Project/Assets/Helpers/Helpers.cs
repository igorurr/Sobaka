...
public static class Helpers {
   ...
   /*public static Action SubscribeOnce( this Action _event, Action _action )
    ...
    #region v2f v2i v4f v4i
	
    public static v2f Tov2f( this Vector3 _vector )
    {
        return new v2f( _vector.x, _vector.y );
    }
	
    public static v2f Tov2f( this Vector2 _vector )
    {
        return new v2f( _vector.x, _vector.y );
    }
	
    public static v2i Tov2i( this Vector2Int _vector )
    {
        return new v2i( _vector.x, _vector.y );
    }
	
    public static v4f Tov4f( this Vector4 _vector )
    {
        return new v4f( _vector.x, _vector.y, _vector.z, _vector.w );
    }
